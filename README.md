...
| 电机运行 | 用户报告 2026-09-23 H6215 已调通，约 28 rps；H3510 因缺专用转接板未测 | H6215 测试台数、原界面单位与参数待补录；新 ESP32 控制链路尚未实测 |
...
| 主控板 | 待清点 | ESP32-S3 | 用户于 2026-09-24 确认已有 S3，开发板完整型号与存储规格待核实 |
...
- [x] 新增控制程序的依赖、构建、模拟及烧录说明；实机烧录与验证仍待现场进行。
