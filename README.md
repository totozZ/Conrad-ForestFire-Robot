...
| 达妙转接板 | 照片中 1 块 | 可见“达妙科技”、正负极及 H／L 标识 | 此前对话中的转接板特写（文件待归档）；具体型号、功能和实际接线待确认 |
...
八张照片已保存在 [docs/images/](docs/images/)，保留上传时的文件名。照片 1 为本文开头的整车照，照片 2–8 如下。
...
整车照片已归档。此前对话中的达妙转接板特写尚未归档；主控板、刀片细节及完整传动路径照片仍待补充。
...
- [x] 八张实物图片（含整车照片和新增相连模块）已归档并在本文展示。
- [ ] 相连的天线模块与 USB 接口板型号、用途、原连接设备及通信对端。
- [ ] 达妙转接板特写归档，以及主控、刀片细节和完整传动路径照片。
