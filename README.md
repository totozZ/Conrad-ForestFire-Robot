...
现已明确：不依赖旧资料，按现有实物重新建立接线与控制方案。当前采用电脑上位机逐台测试，具体见 [接线与单电机调试方案](docs/wiring.md)；后续再接入 ESP32-S3。
...
| 软件与资料 | 重建文档前，仓库为空且没有历史提交 | 目前无旧资料可用，后续按现有实物重建 |
...
- [ ] 主控板正反面照片、准确型号及开发环境。
- [ ] 建立新的上位机操作记录、软件版本及参数备份；后续新增控制程序时记录依赖与烧录方法。
